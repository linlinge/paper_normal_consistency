...
vector<Vector3f> get_corners(Vector3f& vmin, Vector3f& vmax)
{
	vector<Vector3f> rst;
	rst.resize(8);
	rst[0][0]=vmin[0];rst[0][1]=vmin[1];rst[0][2]=vmin[2];
	rst[1][0]=vmin[0];rst[1][1]=vmax[1];rst[1][2]=vmin[2];
	rst[2][0]=vmax[0];rst[2][1]=vmax[1];rst[2][2]=vmin[2];
	rst[3][0]=vmax[0];rst[3][1]=vmin[1];rst[3][2]=vmin[2];
	rst[4][0]=vmin[0];rst[4][1]=vmin[1];rst[4][2]=vmax[2];
	rst[5][0]=vmin[0];rst[5][1]=vmax[1];rst[5][2]=vmax[2];
	rst[6][0]=vmax[0];rst[6][1]=vmax[1];rst[6][2]=vmax[2];
	rst[7][0]=vmax[0];rst[7][1]=vmin[1];rst[7][2]=vmax[2];
    return rst;
}